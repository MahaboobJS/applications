...
export default function PactRestApiConnection() {
    ...
    try {
      const response = await fetch('/api/connections', {
        ...
        body: JSON.stringify({
          ...
          sourceType: 'Pact REST API',
          destinationType: 'Pact REST API',
          sourceConfig: {
    ...
    <Container>
      <Header>
        ...
        <DatabaseInfo>
          ...
          <DatabaseTitle>
            <h2>Pact REST API Configuration</h2>
            <p>API Connection Setup</p>
          </DatabaseTitle>
        </DatabaseInfo>
      </Header>
        ...
        <FormGrid>
          ...
          <div>
            ...
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>Pact REST API Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                Connect to Pact REST API to access contract testing data and verification results. 
                Configure authentication and custom headers as needed.
              </p>
            </div>
          </div>
        </FormGrid>
