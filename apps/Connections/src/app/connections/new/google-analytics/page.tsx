...
const DatabaseIcon = styled.div`
  width: 60px;
  height: 60px;
  background: linear-gradient(45deg, #f4b400, #ff6b35);
  border-radius: 50%;
  display: flex;
  align-items: center;
      ...
      <Header>
        ...
        <DatabaseInfo>
          ...
          <DatabaseTitle>
            ...
            <p>Analytics Connection Setup</p>
          </DatabaseTitle>
        </DatabaseInfo>
      </Header>
        ...
        <FormGrid>
          ...
          <div>
            ...
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>Google Analytics Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                Connect to Google Analytics to extract website traffic and user behavior data. 
                You'll need a Google Analytics Property ID and API Key.
              </p>
            </div>
          </div>
        </FormGrid>
