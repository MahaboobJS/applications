...
export default function DatabricksConnection() {
          ...
          <div>
            ...
            <FormGroup>
              ...
              <Input
                ...
                onChange={handleChange}
                placeholder="Enter Databricks server hostname"
              />
            </FormGroup>
          </div>
            ...
            <FormGroup>
              ...
              <PasswordInput>
                <Input
                  ...
                  onChange={handleChange}
                  placeholder="Enter Databricks access token"
                />
              </PasswordInput>
            </FormGroup>
            
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>Databricks Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                Connect to Databricks to access your data lakehouse. 
                You'll need a Databricks workspace URL, HTTP path, and access token.
              </p>
            </div>
          </div>
        </FormGrid>
