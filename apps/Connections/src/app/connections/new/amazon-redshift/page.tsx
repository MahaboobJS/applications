...
export default function AmazonRedshiftConnection() {
    ...
    try {
      const response = await fetch('/api/connections', {
        ...
        body: JSON.stringify({
          ...
          destinationType: 'Amazon Redshift',
          sourceConfig: {
    ...
    <Container>
      <Header>
        ...
        <DatabaseInfo>
          ...
          <DatabaseTitle>
            <h2>Amazon Redshift Configuration</h2>
          ...
          <div>
            <FormGroup>
              ...
              <Input
                ...
                onChange={handleChange}
                placeholder="Enter Redshift cluster endpoint"
              />
            </FormGroup>
