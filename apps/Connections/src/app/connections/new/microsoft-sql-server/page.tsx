...
const DatabaseIcon = styled.div`
  width: 60px;
  height: 60px;
  background: linear-gradient(45deg, #cc2927, #ff6b35);
  border-radius: 50%;
  display: flex;
  align-items: center;
  justify-content: center;
  font-size: 28px;
  box-shadow: 0 8px 20px rgba(204, 41, 39, 0.3);
`;
...
const Input = styled.input`
  ...
  &:focus {
    outline: none;
    border-color: #cc2927;
    box-shadow: 0 0 0 3px rgba(204, 41, 39, 0.1);
  }
...
export default function SQLServerConnection() {
    ...
    try {
      const response = await fetch('/api/connections', {
        ...
        body: JSON.stringify({
          ...
          destinationType: 'Microsoft SQL Server',
          sourceConfig: {
    ...
    <Container>
      <Header>
        ...
        <DatabaseInfo>
          ...
          <DatabaseTitle>
            <h2>Microsoft SQL Server Configuration</h2>
