...
export default function AmazonS3Connection() {
        ...
        <FormGrid>
          ...
          <div>
            ...
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>Amazon S3 Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                Connect to Amazon S3 to access CSV files stored in your buckets. 
                You'll need AWS credentials and bucket permissions.
              </p>
            </div>
          </div>
        </FormGrid>
