...
export default function BigQueryConnection() {
        ...
        <FormGrid>
          ...
          <div>
            ...
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>BigQuery Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                Connect to Google BigQuery to access your data warehouse. 
                You'll need a Google Cloud Project ID, Dataset ID, and service account credentials.
              </p>
            </div>
          </div>
        </FormGrid>
