...
export default function BoxConnection() {
          ...
          <div>
            <FormGroup>
              ...
              <Input
                ...
                onChange={handleChange}
                placeholder="Enter Box access token"
              />
            </FormGroup>
            
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>Box Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                Connect to Box to access CSV files stored in your folders. 
                You'll need a Box access token and folder ID.
              </p>
            </div>
          </div>
        </FormGrid>
