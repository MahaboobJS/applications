...
export default function FileSystemConnection() {
        ...
        <FormGrid>
          <div>
            ...
            <FormGroup>
              ...
              <Input
                ...
                onChange={handleChange}
                placeholder="Enter path to CSV file or directory"
              />
            </FormGroup>
          </div>
          ...
          <div>
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>File System Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                Connect to local file system to access CSV files. 
                Provide the path to your CSV file or directory containing CSV files.
              </p>
            </div>
          </div>
        </FormGrid>
