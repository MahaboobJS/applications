...
export default function DuckDBConnection() {
        ...
        <FormGrid>
          ...
          <div>
            <div style={{ padding: '20px', background: 'rgba(255, 255, 255, 0.5)', borderRadius: '12px', marginTop: '20px' }}>
              <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>DuckDB Information</h3>
              <p style={{ margin: '0', color: '#666', fontSize: '14px' }}>
                DuckDB is an in-process SQL OLAP database management system. 
                Simply provide the path to your DuckDB database file.
              </p>
            </div>
          </div>
        </FormGrid>
